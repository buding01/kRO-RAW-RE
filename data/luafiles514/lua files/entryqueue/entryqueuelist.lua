EntryQueueList = {
  [1] = {
    ...
    RewardDraw = "용맹휘장 1개",
    RewardLose = "용맹휘장 1개",
    VictoryCond = "상대 진영의 저장고 파괴",
    MiniMapFile = "bat_a01.bmp"
  },
  [2] = {
    BattleFieldName = "Flavius",
    DisplayBattleFieldName = "플라비우스",
    AllianceNum = 6,
    EnemyNum = 6,
    PrivateApply = 1,
    PartyApply = 1,
    ...
    RewardDraw = "특공휘장 3개",
    RewardLose = "특공휘장 3개",
    VictoryCond = "상대 진영의 크리스탈 파괴",
    MiniMapFile = "bat_b01.bmp"
  },
  [3] = {
    BattleFieldName = "KVM (Lv80이상)",
    DisplayBattleFieldName = "KVM (Lv80이상)",
    AllianceNum = 5,
    EnemyNum = 5,
    PrivateApply = 1,
    PartyApply = 1,
  ...
  [5] = {
    ...
    DisplayBattleFieldName = "KVM (Lv59이하)",
    AllianceNum = 5,
    EnemyNum = 5,
    PrivateApply = 1,
    PartyApply = 1,
