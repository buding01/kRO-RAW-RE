...
StateIconImgList = {
  ...
  [PRIORITY_WHITE] = {
    ...
    [EFST_IDs.EFST_AID_PERIOD_RECEIVEITEM] = "item.TGA",
    [EFST_IDs.EFST_AID_PERIOD_PLUSEXP] = "exp.TGA",
    [EFST_IDs.EFST_AID_PERIOD_PLUSJOBEXP] = "job.TGA",
    [EFST_IDs.EFST_AID_PERIOD_DEADPENALTY] = "gogi.TGA",
    [EFST_IDs.EFST_AID_PERIOD_ADDSTOREITEMCOUNT] = "gogi.TGA"
  }
}
