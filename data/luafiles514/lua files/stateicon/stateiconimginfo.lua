...
StateIconImgList = {
  ...
  [PRIORITY_BLUE] = {
    ...
    [EFST_IDs.EFST_ATTACK_PROPERTY_WATER] = "Weapon_property_Water.TGA",
    [EFST_IDs.EFST_ATTACK_PROPERTY_GROUND] = "Weapon_property_Ground.TGA",
    [EFST_IDs.EFST_ATTACK_PROPERTY_FIRE] = "Weapon_property_Fire.TGA",
    [EFST_IDs.EFST_ATTACK_PROPERTY_WIND] = "Weapon_property_Wind.TGA",
