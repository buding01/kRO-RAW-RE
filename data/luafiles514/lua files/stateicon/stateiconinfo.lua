...
StateIconList[EFST_IDs.EFST_MTF_LUDE] = {
  ...
  posTimeLimitStr = 2,
  descript = {
    {"루드 변신", COLOR_TITLE_BUFF},
    {"%s", COLOR_TIME},
    {
      "모로크의 현신에게 주는 데미지 20% 증가"
    }
  }
}
