Weapon_IDs = {
  ...
  WEAPONTYPE_Katana = 43,
  WEAPONTYPE_Bastard_Sword = 44,
  WEAPONTYPE_Broad_Sword = 45,
  WEAPONTYPE_Violet_Fear = 46,
  WEAPONTYPE_Lance = 52,
...
WeaponNameTable = {
  ...
  [Weapon_IDs.WEAPONTYPE_TWOHANDSWORD] = "_¾ç¼Õ°Ë",
  [Weapon_IDs.WEAPONTYPE_SPEAR] = "_Ã¢",
  [Weapon_IDs.WEAPONTYPE_TWOHANDSPEAR] = "_¾ç¼ÕÃ¢",
  [Weapon_IDs.WEAPONTYPE_AXE] = "_µµ³¢",
  [Weapon_IDs.WEAPONTYPE_TWOHANDAXE] = "_¾ç¼Õµµ³¢",
